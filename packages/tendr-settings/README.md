...
```bash
php artisan vendor:publish --provider="Tallmancode\TendrSettings\LaravelSettingsServiceProvider" --tag="migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --provider="Tallmancode\TendrSettings\LaravelSettingsServiceProvider" --tag="settings"
```
...
```php
use Tallmancode\TendrSettings\Migrations\SettingsMigration;
